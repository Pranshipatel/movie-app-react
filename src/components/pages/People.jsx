...
const People = () => {
  ...
  return people.length > 0 ? (
    <div className="w-screen h-screen  overflow-y-auto overflow-x-hidden bg-[#1F1E24] text-white">
      <div className="px-7 py-2 w-full flex justify-between items-center">
